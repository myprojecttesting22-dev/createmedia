...
const TrustFrame = () => {
  ...
  const testimonials = [
    ...
    { name: "Michael Chen", company: "Urban Real Estate Group", role: "Marketing Director", content: "Working with CREATE MEDIA has been a game-changer. The automated marketing systems they built for us save countless hours while delivering consistent, high-quality content across all platforms.", rating: 5 },
        ...
        <div className="container mx-auto">
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              <StatCircle value="34" label="Clients Served" percentage={75} color="blue" delay={0} />
              <StatCircle value="22M" label="Views Generated" percentage={90} color="purple" delay={200} />
              <StatCircle value="104K" label="Revenue Growth" percentage={85} color="cyan" delay={400} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className="depth-card p-6 animate-slide-up"
